...
import { BadgeComponent, Modal } from '@ui';
 ...
 *
 * Muestra la versión actual del build en una esquina de la pantalla usando un BadgeComponent.
 * Opcionalmente puede mostrar información detallada al hacer click, usando Modal de @ui.
 *
 * @example
 * ```tsx
    ...
    <>
      ...
      {showDetails && showModal && (
        <Modal
          ...
          onCloseOutside={() => setShowModal(false)}
          onCloseEscape={() => setShowModal(false)}
